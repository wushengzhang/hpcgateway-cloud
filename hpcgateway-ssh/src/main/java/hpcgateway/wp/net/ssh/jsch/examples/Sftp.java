 ...
 *
 */
package hpcgateway.wp.net.ssh.jsch.examples;
import hpcgateway.wp.net.ssh.jsch.*;
import java.awt.*;
import javax.swing.*;
...
//		out.println(vv.elementAt(ii).toString());
                ...
                if(obj instanceof hpcgateway.wp.net.ssh.jsch.ChannelSftp.LsEntry){
                  out.println(((hpcgateway.wp.net.ssh.jsch.ChannelSftp.LsEntry)obj).getLongname());
                }
...
/*
  public static class MyProgressMonitor implements hpcgateway.wp.net.ssh.jsch.ProgressMonitor{
